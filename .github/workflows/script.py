...
save_path = f'/home/runner/work/joda-time/joda-time/optimizing-ci-builds-ci-analysis/job.csv'
# write the current_run_id to the file job.csv
with open(save_path, 'w') as f:
    f.write(current_run_id  + ',' + job_id + ',' + f"joda-time" + ',' + workflow)
...
if (info_flag == 1) :
    for step, (starting_index, ending_index) in steps.items():
        ...
        if step_name != '':
            if not os.path.exists(f'/home/runner/work/joda-time/joda-time/optimizing-ci-builds-ci-analysis/step-details/{step_name}'):
    ...
    useful_df.to_csv(f'/home/runner/work/joda-time/joda-time/optimizing-ci-builds-ci-analysis/useful.csv')
...
shutil.copy2("/home/runner/inotify-logs.csv", "/home/runner/work/joda-time/joda-time/optimizing-ci-builds-ci-analysis/")

size = 0
Folderpath = "/home/runner/work/joda-time/joda-time/optimizing-ci-builds-ci-analysis"
...
if size > 99000000:
    ...
    os.mkdir(Folderpath)
    shutil.move("/home/runner/work/joda-time/joda-time/optimizing-ci-builds-ci-analysis.zip", "/home/runner/work/joda-time/joda-time/optimizing-ci-builds-ci-analysis")
